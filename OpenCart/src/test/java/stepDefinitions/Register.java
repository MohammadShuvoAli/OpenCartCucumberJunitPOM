...
public class Register {
	...
	public void user_enters_provided_the_details_into_below_fields(DataTable dataTable) {
	    Map<String, String> dataMap = dataTable.asMap(String.class, String.class);
	    ...
	    registerPage.enterFirstName(dataMap.get("firstName"));
	    registerPage.enterLastName(dataMap.get("lastName"));
	    registerPage.enterEmailAddress(CommonUtils.getGeneratedEmail());
	    registerPage.enterTelephoneNumber(dataMap.get("telephone"));
	    registerPage.enterPassword(CommonUtils.getGeneratedPassword());
	    registerPage.enterConfirmPassword(CommonUtils.getGeneratedPassword());
	}
